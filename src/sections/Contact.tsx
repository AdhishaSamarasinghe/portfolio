          ...
          <div className="card p-7">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                onClick={copyEmail}
                className="rounded-xl border border-white/[0.12] bg-white/[0.04] px-3 py-2 text-xs font-semibold text-slate-100/[0.8] transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
          ...
          <div className="mt-6 grid gap-5">
            <label className="grid gap-2">
              ...
              <input
                ...
                className="h-12 rounded-xl border border-white/10 bg-white/[0.03] px-4 text-base text-slate-100/90 outline-none placeholder:text-slate-200/40 focus:border-white/40 focus:bg-white/[0.05] focus:ring-1 focus:ring-white/25"
            ...
            <label className="grid gap-2">
              ...
              <textarea
                ...
                className="min-h-36 resize-y rounded-xl border border-white/10 bg-white/[0.03] px-4 py-4 text-base text-slate-100/90 outline-none placeholder:text-slate-200/40 focus:border-white/40 focus:bg-white/[0.05] focus:ring-1 focus:ring-white/25"
